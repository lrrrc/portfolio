  ...
  return (
    <main>
      <div className="flex flex-col font-space text-zinc-50 justify-center mt-[15rem] ml-[30rem] gap-3">
        ...
        <p className="text-2xl font-semibold">My name is Leonardo Cardoso</p>
        <p className="text-lg font-normal">
          I am a full stack developer. I currently study and work as a intern at{" "}
          <a
        ...
        <p className="text-lg">
          You can see my{" "}
          <a className="border-b-2 text-left cursor-pointer" href="/projects">
            projects
          </a>
          .
        </p>
        <div className="flex flex-row gap-2">
          <Link href="https://github.com/lrrrc" target="_blank">
